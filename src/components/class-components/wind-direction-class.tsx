import {
  ...
  PointerType,
  Section,
  WindDirection as ssWindDirection,
  WindDirectionParams,
} from "steelseries"
...
export class WindDirection extends GaugeComponent<
  Props,
  ssWindDirection,
  WindDirectionParams
> {
  ...
  gaugePostInit(animate: boolean) {
    if (this.props.ltsValue) {
      this.props.animate && animate
        ? this.gauge.setValueAnimatedLatest(
            this.props.ltsValue,
            this.props.lstAnimationCallback
          )
    ...
    if (this.props.avgValue) {
      this.props.animate && animate
        ? this.gauge.setValueAnimatedAverage(
            this.props.avgValue,
            this.props.avgAnimationCallback
          )
